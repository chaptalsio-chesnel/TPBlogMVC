...
function getBdd() {
	$bdd = new PDO('mysql:host=localhost;dbname=tpblogmvc;charset=utf8', 'ts2', 'ts2', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
	return $bdd;
}
...
abstract class Modele {
  ...
  private function getBdd() {
    if ($this->bdd == null) {
      ...
      $this->bdd = new PDO('mysql:host=localhost;dbname=tpblogmvc;charset=utf8',
